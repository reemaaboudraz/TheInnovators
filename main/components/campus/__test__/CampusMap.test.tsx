...
describe("CampusMap - building shapes (Polygon/Marker)", () => {
  it("pressing a Polygon selects it and animates", () => {
    const { getByTestId } = render(<CampusMap />);
  ...
  it("pressing a Marker selects it and animates", () => {
    const { getByTestId } = render(<CampusMap />);
...
describe("CampusMap - polygon optional branch coverage", () => {
  it("selecting a building with empty polygon falls back to fixed deltas", () => {
    const { getByTestId } = render(<CampusMap />);
