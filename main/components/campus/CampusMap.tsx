...
import { View, Text, Platform, StyleSheet, Alert, TextInput, Pressable } from "react-native";
import MapView, { PROVIDER_GOOGLE, Region, Marker, MapPressEvent } from "react-native-maps";
...
import CurrentLocationButton, { UserLocation } from "@/components/campus/CurrentLocationButton";
import BuildingPopup from "@/components/campus/BuildingPopup";
import NavigationSearchCard, { type SelectionMode } from "@/components/campus/NavigationSearchCard";
...
export { calculatePanValue, determineCampusFromPan } from "@/components/campus/ToggleButton";
...
export default function CampusMap() {
    ...
    const ALL_BUILDINGS = useMemo(() => [...SGW_BUILDINGS, ...LOYOLA_BUILDINGS], []);
    ...
    const handleGetDirections = () => {
        ...
        Alert.alert("Directions ready", `${startBuilding.code} → ${destinationBuilding.code}`);
    };
    ...
    const handleMapPress = (e: MapPressEvent) => {
        ...
        const dropped = buildDroppedPin(latitude, longitude, focusedCampus, selectionMode);
        applyBuildingToActiveField(dropped);
    };

    // Keep "code - name" formatting for compatibility with tests and flows
    const startValue = startBuilding ? `${startBuilding.code} - ${startBuilding.name}` : "";
    ...
    return (
        <View style={styles.container} testID="campusMap-root">
            ...
            <View style={styles.topOverlay} testID="topOverlay">
                ...
                <ToggleButton focusedCampus={focusedCampus} onCampusChange={handleCampusChange} />
